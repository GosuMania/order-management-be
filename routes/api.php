...
Route::controller(OrderProductController::class)->prefix('order-product')->group(function () {
    Route::get('get-order-product-stats/{idProvider}', 'getOrderProductStats');
    Route::get('get-with-pagination-order-product-stats/{ascDesc}/{perPage}/{page}/{idSeason}/{idProvider}', 'getOrderProductStatsWithPaginationListSearch')->middleware('auth:api');
